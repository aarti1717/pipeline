...
role='arn:aws:iam::778784494011:role/rde_cfnsadmin'
###
# Resources
##

file1='file://cfn_resources.yml'
stackname1='RANI-RDE-API-PIPELINE-RESOURCES'
...
stackname2='RANI-RDE-API-PIPELINE-RANI'
